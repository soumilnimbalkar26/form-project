    ...
    <SafeAreaView style={style.container}>
      ...
      >
        ...
        <Pressable
          ...
          onPress={() => setAgreedToDeclaration((prev) => !prev)}
        >
          <View
            style={[
              style.checkbox,
              agreedToDeclaration && style.checkboxChecked,
            ]}
          >
            {agreedToDeclaration && <Text style={style.checkmark}>✓</Text>}
          </View>
          <Text style={style.checkboxLabel}>I agree to the declaration</Text>
        </Pressable>
        ...
        <TextInput
          ...
          onChangeText={setDeclarationDate}
          placeholder="DD/MM/YYYY"
          placeholderTextColor="#B0A69A"
        />
