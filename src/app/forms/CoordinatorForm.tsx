...
const DEFAULT_VALUES: CoordinatorFormData = {
  fullName: "",
  fatherSpouseName: "",
  dob: new Date(),
  gender: null,
...
async function submitCoordinatorApplication(payload: CoordinatorFormData) {
  const response = await fetch(`${API_BASE_URL}/api/coordinatorform`, {
    method: "POST",
    headers: {
...
const CoordinatorForm = () => {
  ...
  const onSubmit = async (data: CoordinatorFormData) => {
    setIsSubmitting(true);
    try {
      const result = await submitCoordinatorApplication(data);
      console.log("Coordinator Form Submitted:", data, "API response:", result);
      Alert.alert("Success", "Coordinator application submitted successfully.");
    } catch (error) {
      console.error("Coordinator form submission failed:", error);
      Alert.alert(
        "Submission Failed",
  ...
  return (
    <SafeAreaView style={style.container}>
      ...
      >
        ...
        <Text style={style.title}>Coordinator Application Form</Text>
