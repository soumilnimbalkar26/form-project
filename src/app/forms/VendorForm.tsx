...
const DEFAULT_VALUES: VendorFormData = {
  fullName: "",
  fatherSpouseName: "",
  dob: new Date(),
  gender: null,
...
async function submitVendorApplication(payload: VendorFormData) {
  const response = await fetch(`${API_BASE_URL}/api/vendorform`, {
    method: "POST",
    headers: {
...
const VendorForm = () => {
  ...
  const onSubmit = async (data: VendorFormData) => {
    ...
    try {
      ...
      console.log("Vendor Form Submitted:", data, "API response:", result);
  ...
  return (
    <SafeAreaView style={style.container}>
      ...
      >
        ...
        <Text style={style.title}>Vendor Application Form</Text>
